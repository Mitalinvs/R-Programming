...
# rscript abc.R : to run R program in command prompt, need to set path
# cntl A, cntl enter to run complete file
###############################################################



#-------------------------------------------------------------
# Step 1: Simple Examples  #place cusor cntl+enter to run
#-------------------------------------------------------------
2 + 2                 # Addition
a=10                  # To assign
b=20
...
#-------------------------------------------------------------
# Step 2: Generate Random Number   #select and press cntl,enter to run it multiple times
#-------------------------------------------------------------
